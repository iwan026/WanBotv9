...
//======================================\\
//------------------------ < T O P  U P  G A M E > ------------------------\\
const { mobilelegends } = require('./plugins/mobilelegends')
const { freefire } = require('./plugins/freefire')
const { pubg } = require('./plugins/pubg')
const { arenaofvalor }  = require('./plugins/arenaofvalor')
const { callofduty } = require('./plugins/callofduty')
const { hggsdomino } = require('./plugins/higgsdomino')
const { genshinimpact } = require('./plugins/genshinimpact')
const { valorant }  = require('./plugins/valorant')
const { sausageman }  = require('./plugins/sausageman')

//------------------------ < I S I  U L A N G  P U L S A > ------------------------\\
const { telkomsel } = require('./plugins/telkomsel')
const { indosat } = require('./plugins/indosat')
const { axis } = require('./plugins/axis')
const { three } = require('./plugins/three')
const { xl } = require('./plugins/xl') 
const { smartfren } = require('./plugins/smartfren') 
//------------------------ < T O P  U P  S A L D O > ------------------------\\
const { saldodana } = require('./plugins/saldodana')
const { saldogopay } = require('./plugins/saldogopay')
const { saldoovo } = require('./plugins/saldoovo')
const { saldolinkaja} = require('./plugins/saldolinkaja')
const { saldoshopee} = require('./plugins/saldoshopee') 

//------------------------ < T O K E N  L I S T R I K> ------------------------\\
const { llistrik } = require('./plugins/listrik')
...
> 532 ${prefix}nsfw_avatar`
        ...
        if (isBanned) return freply(mess.banned)
               list = []
               listmenu = [`game`,`pulsa`,`ewallet`,`listrik`,`japost`,`jaber`,`allmenu`,`storemenu`,`infomenu`,`groupmenu`,`gamemenu`]
               listmenuu = [`TOP UP GAME`,`ISI ULANG PULSA`,`TOP UP SALDO EWALLET`,`TOKEN LISTRIK`,`JASA POST FREE`,`JASA REKBER`]
               nombor = 1
               startnum = 0
...
//----------------<store menu>----------------
               ...
               if (isBanned) return freply(mess.banned)
               list = []
               liststore = [`ml`,`ff`,`pubg`,`aov`,`codm`,`chip`,`crystal`,`point`,`candy`]
               liststoree= [`MOBILE LEGENDS`,`FREE FIRE`,`PUBG MOBILE`,`ARENA OF VALOR`,`CALL OF DUTY`,`HIGGS DOMINO`,`GENSHIN IMPACT`,`VALORANT`,`SAUSAGE MAN`]
               nombor = 1
               startnum = 0
               ...
               if (isBanned) return freply(mess.banned)
               list = []
               liststore = [`tsel`,`indosat`,`axis`,`three`,`xl`,`smart`]
               liststoree= [`PULSA TELKOMSEL`,`PULSA INDOSAT`,`PULSA AXIS`,`PULSA THREE`,`PULSA XL`,`PULSA SMARTFREN`]
               nombor = 1
               startnum = 0
               for (let x of liststore) {
...
case 'ewallet':
               ...
               freply(mess.wait)
               list = []
               liststore = [`topupdana`,`topupgopay`,`topupovo`,`topuplinkaja`,`topupshopee`]
               liststoree= [`SALDO DANA`,`SALDO GOPAY`,`SALDO OVO`,`SALDO LINKAJA`,`SALDO SHOPEEPAY`]
               nombor = 1
               startnum = 0
               for (let x of liststore) {
               const yy = {title: 'Top Up' + nombor++,
...
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, mobilelegends(prefix, nomorowner), MessageType.text, {quoted: troli})
break                
case 'ff':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, freefire(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'pubg':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, pubg(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'aov':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, arenaofvalor(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'codm':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, callofduty(prefix, nomorowner), MessageType.text, {quoted: troli})
break                
case 'chip':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, higgsdomino(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'crystal':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, genshinimpact(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'point':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, valorant(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'candy':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, sausageman(prefix, nomorowner), MessageType.text, {quoted: troli})
break
//ISI ULANG PULSA
case 'tsel':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, telkomsel(prefix), text)
break
case 'indosat':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, indosat(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'axis':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, axis(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'xl':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, xl(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'smart':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, smartfren(prefix, nomorowner), MessageType.text, {quoted: troli})
break
//TOP UP SALDO
case 'topupdana':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, saldodana(prefix), text)
break
case 'topupgopay':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, saldogopay(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'topupovo':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, saldoovo(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'topuplinkaja':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, saldolinkaja(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'topupshopee':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, saldoshopee(prefix, nomorowner), MessageType.text, {quoted: troli})
break
case 'listrik':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
Ramdani.sendMessage(from, listrik(prefix, nomorowner), MessageType.text, {quoted: troli})
break
